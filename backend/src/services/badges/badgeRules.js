...
export const badgeRules = [
  ...
  // ← NEW: edu badge rule
  // edu_verified is injected into rawMetrics by the worker before calling computeBadges
  {
    id: "edu_verified",
    condition: (rawMetrics) =>
      rawMetrics.edu_verified === true && !!rawMetrics.collegeDomain
  }
];